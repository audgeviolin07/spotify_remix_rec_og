const APIController = (function() {
    ...
    const _searchTracks = async (token, query) => {
        ...
        const result = await fetch(`https://api.spotify.com/v1/search?q=${encodedQuery}&type=track&limit=10`, {
            method: 'GET',
            headers: { 'Authorization' : 'Bearer ' + token }
        });
        const data = await result.json();
...
const UIController = (function() {
    ...
    const DOMElements = {
        ...
        trackUrl: '#track_url',
        btnFindOriginal: '#btn_find_original'
    }
    ...
    return {
        ...
        inputField() {
            return {
                ...
                trackUrl: document.querySelector(DOMElements.trackUrl),
                findOriginal: document.querySelector(DOMElements.btnFindOriginal)
            }
        },
...
const APPController = (function(UICtrl, APICtrl) {
    ...
    const findOriginalTrack = async () => {
        ...
        const remixDetails = await APICtrl.getTrack(token, `https://api.spotify.com/v1/tracks/${trackId}`);
    ...
    DOMInputs.findOriginal.addEventListener('click', async (e) => {
        e.preventDefault();
        await findOriginalTrack();
    });
